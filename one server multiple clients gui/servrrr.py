...
def ClickAction():
    ...
    connection.sendall(EntryText.encode())
...
# ---------------------------------------------------#
def GetConnected(connection, client_address):
...
def start_communication_thread():
    while True:
        ...
        _thread.start_new_thread(GetConnected, (connection, client_address))

_thread.start_new_thread(start_communication_thread, ())
